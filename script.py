...
def process_subscription(sub, credential) -> Tuple[List[Dict[str, Any]], List[Dict[str, Any]]]:
    ...
    return summary_rows, noncompliant_rows
...
def main():
    ...
    # Mantém colunas mesmo se vazias, quando dataframe não possui todas usa reindex
